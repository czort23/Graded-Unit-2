...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-10 col-md-6">
                ...
                <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in 
                    ...
                    the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank">Privacy Policy Generator</a>.</p>
                <br>
                <p class="table-of-content"><a href="#1">1. Interpretation and Definitions</a></p>
                <p class="table-of-content"><a href="#1-1">1-1. Interpretation</a></p>
                <p class="table-of-content"><a href="#1-2">1-2. Definitions</a></p>
                <p class="table-of-content"><a href="#2">2. Collecting and Using Your Personal Data</a></p>
                <p class="table-of-content"><a href="#2-1">2-1. Types of Data Collected</a></p>
                <p class="table-of-content"><a href="#2-1-1">2-1-1. Personal Data</a></p>
                <p class="table-of-content"><a href="#2-1-2">2-1-2. Usage Data</a></p>
                <p class="table-of-content"><a href="#2-1-3">2-1-3. Tracking Technologies and Cookies</a></p>
                <p class="table-of-content"><a href="#2-2">2-2. Use of Your Personal Data</a></p>
                <p class="table-of-content"><a href="#2-3">2-3. Retention of Your Personal Data</a></p>
                <p class="table-of-content"><a href="#2-4">2-4. Transfer of Your Personal Data</a></p>
                <p class="table-of-content"><a href="#2-5">2-5. Delete Your Personal Data</a></p>
                <p class="table-of-content"><a href="#2-6">2-6. Disclosure of Your Personal Data</a></p>
                <p class="table-of-content"><a href="#2-6-1">2-6-1. Business Transactions</a></p>
                <p class="table-of-content"><a href="#2-6-2">2-6-2. Law enforcement</a></p>
                <p class="table-of-content"><a href="#2-6-3">2-6-3. Other legal requirements</a></p>
                <p class="table-of-content"><a href="#2-7">2-7. Security of Your Personal Data</a></p>
                <p class="table-of-content"><a href="#3">3. Links to Other Websites</a></p>
                <p class="table-of-content"><a href="#4">4. Changes to this Privacy Policy</a></p>
                <br>
                <h3 id="1">1. Interpretation and Definitions</h3>
                <br>
                <h4 id="1-1">1-1. Interpretation</h4>
                <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. 
                    The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
                <br>
                <h4 id="1-2">1-2. Definitions</h4>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        &quot;Our&quot; in this Agreement) refers to Non-profit, Edinburgh.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Sustain Energy, accessible from <a href="http://localhost/gu2/index.php" rel="external nofollow noopener" target="_blank">http://localhost/gu2/index.php</a></p>
                    </li>
                    <li>
                ...
                <br>
                <h3 id="2">2. Collecting and Using Your Personal Data</h3>
                <br>
                <h4 id="2-1">2-1. Types of Data Collected</h4>
                <br>
                <h4 id="2-1-1">2-1-1. Personal Data</h4>
                ...
                <br>
                <h4 id="2-1-2">2-1-2. Usage Data</h4>
                ...
                <br>
                <h4 id="2-1-3">2-1-3. Tracking Technologies and Cookies</h4>
                ...
                <ul>
                    ...
                    You may not be able to use some parts of our Service. Unless you have adjusted Your browser setting so that it will 
                    ...
                    known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for 
                    example, to count users who have visited those pages or opened an email and for other related website statistics (for 
                    example, recording the popularity of a certain section and verifying system and server integrity).</li>
                </ul>
                ...
                <br>
                <h4 id="2-2">2-2. Use of Your Personal Data</h4>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        contract for the products, items or services You have purchased or of any other contract with Us through the Service.</p>
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint 
                ...
                <br>
                <h4 id="2-3">2-3. Retention of Your Personal Data</h4>
                ...
                <br>
                <h4 id="2-4">2-4. Transfer of Your Personal Data</h4>
                ...
                <br>
                <h4 id="2-5">2-5. Delete Your Personal Data</h4>
                ...
                <p>Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis 
                    to do so.</p>
                <br>
                <h4 id="2-6">2-6. Disclosure of Your Personal Data</h4>
                <br>
                <h4 id="2-6-1">2-6-1. Business Transactions</h4>
                ...
                <br>
                <h4 id="2-6-2">2-6-2. Law enforcement</h4>
                ...
                <br>
                <h4 id="2-6-3">2-6-3. Other legal requirements</h4>
                ...
                <br>
                <h4 id="2-7">2-7. Security of Your Personal Data</h4>
                ...
                <br>
                <h3 id="3">3. Links to Other Websites</h3>
                ...
                <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party 
                    sites or services.</p>
                <br>
                <h3 id="4">4. Changes to this Privacy Policy</h3>
    ...
    <footer class="footer footer-black">
        ...
        <a class="footer-nav footnav-black" href="terms_of_service.php">Terms of Service</a>&emsp;
        <a class="footer-nav footnav-black" href="#.php">Privacy Policy</a>
        <br><br>
